    ...
    function(response) {
      ...
      if (response) {
        response.forEach(function(anteprimaGuida, index) {
          ...
          $('#'+parent[index]).find('.vaiGuida').attr('href','home/guideacquistotech/'+anteprimaGuida.anteprima.link);
